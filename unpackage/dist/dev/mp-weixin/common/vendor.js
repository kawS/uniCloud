...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__741DC0D",
    appName: "dbsfwdatabase",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const globalStyle = {
  ...
  navigationBarTitleText: "Dragon Ball Super Card Game Fusion World",
...
const S = true, b = "mp-weixin", A = I([]), P = b, T = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.5.194",\n        "192.168.5.177"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7001,\n    "skipFiles": [\n        "<node_internals>/**",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), C = I('[{"provider":"aliyun","spaceName":"demo","spaceId":"mp-6b9c677a-de26-4f52-a162-e346d16df57c","clientSecret":"il3FhEX5wGx7Cgdb4Od6sg=="}]') || [];
let O = "";
try {
  O = "__UNI__741DC0D";
} catch (e2) {
